...
<div>
<p><strong>Input:</strong> <span>nums = [4,3,2,1]</span></p>

<p><strong>Output:</strong> <span>[0,0,1,1]</span></p>
...
<div>
<p><strong>Input:</strong> <span>nums = [1,5,1,4,2]</span></p>

<p><strong>Output:</strong> <span>[0,0,1,1,1]</span></p>
