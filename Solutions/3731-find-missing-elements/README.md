...
<div>
<p><strong>Input:</strong> <span>nums = [1,4,2,5]</span></p>
...
<div>
<p><strong>Input:</strong> <span>nums = [7,8,6,9]</span></p>
...
<div>
<p><strong>Input:</strong> <span>nums = [5,1]</span></p>

<p><strong>Output:</strong> <span>[2,3,4]</span></p>
