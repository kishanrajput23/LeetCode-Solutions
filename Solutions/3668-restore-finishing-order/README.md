...
<div>
<p><strong>Input:</strong> <span>order = [3,1,2,5,4], friends = [1,3,4]</span></p>

<p><strong>Output:</strong> <span>[3,1,4]</span></p>
...
<div>
<p><strong>Input:</strong> <span>order = [1,4,5,3,2], friends = [2,5]</span></p>

<p><strong>Output:</strong> <span>[5,2]</span></p>
