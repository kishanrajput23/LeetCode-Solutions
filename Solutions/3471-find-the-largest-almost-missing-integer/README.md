...
<div>
<p><strong>Input:</strong> <span>nums = [3,9,2,1,7], k = 3</span></p>
...
<div>
<p><strong>Input:</strong> <span>nums = [3,9,7,2,1,7], k = 4</span></p>
...
<div>
<p><strong>Input:</strong> <span>nums = [0,0], k = 1</span></p>
